...
- Bandeau « Course en cours » sur les pages d'analyse (superman, performance, régularité, regroupements, récapitulatif, duel) : les analyses ne sont pas interprétées tant que les données ne sont pas complètes.
