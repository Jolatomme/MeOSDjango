"""
Django settings for MeOSDjango project.
...
SECRET_KEY = 'django-insecure-g@y2k4bcsrrb^id4_z5m0_(u4m6lfmxmp)g=6lf2n&#v$5cuuw'
...
INSTALLED_APPS = [
    ...
    'results',
    'ochecklist',  # Added O'checklist app
    'django_extensions',
]
...
WSGI_APPLICATION = 'MeOSDjango.wsgi.application'
...
try:
    ...
    print("Could not import dev_settings")
...
SITE_SUBTITLE = os.environ.get('SITE_SUBTITLE', 'https://github.com/Jolatomme/MeOSDjango')
...
# Set these in dev_settings.py or environment variables for production
OCHECKLIST_HEADER_KEY = os.environ.get('OCHECKLIST_HEADER_KEY', '')  # e.g., 'X-Ochecklist-Token'
OCHECKLIST_HEADER_VALUE = os.environ.get('OCHECKLIST_HEADER_VALUE', '')  # e.g., 'your-secret-token'
